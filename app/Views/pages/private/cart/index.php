                            ...
                            <?php foreach ($carts as $key => $cart) : ?>
                                <tr>
                                    <td class="align-middle">
                                        <input type="checkbox" name="selected_products[]" data-product-id="<?= $cart['product_id'] ?>">
                                    </td>
                                    <td class="align-middle">
                                    ...
                                    <td class="align-middle">
                                        <input type="number" name="qty-<?= $cart['product_id'] ?>" class="form-control" value="<?= $cart['quantity'] ?>" max="<?= $cart['product_stock'] ?>">
                                    </td>
                                    <td class="align-middle">
